...
import turi.practice.tinderclone.activities.UserInfoActivity
import turi.practice.tinderclone.util.Users

class CardsAdapter(context: Context, resourceId: Int, users: List<Users>): ArrayAdapter<Users>(context, resourceId, users) {
